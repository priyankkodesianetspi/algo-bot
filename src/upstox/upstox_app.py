...
from src.indicators import indicators, get_indicators, calculate_signals
...
def historical_data():
    ...
    to_date = data.get('to_date', '2023-11-13')
    from_date = data.get('from_date', '2022-11-12')
    ...
    response = indicators(df)
    df = pd.read_json(response)
    save_to_csv(df, instrument_key)
